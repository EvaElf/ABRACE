...
function changeColor(colors) {
	...
	if (colors.id == "bluecombi"){
		...
		colorChoice.innerText = "Blå, tekstil/kunstlæder";
		price.innerText = "10.458 DKK";
	}
	...
	if (colors.id == "gray"){
		...
		colorChoice.innerText = "Mørkegrå, tekstil";
		price.innerText = "8.964 DKK";
	}
	...
	if (colors.id == "graycombi"){
		...
		colorChoice.innerText = "Mørkgrå, tekstil/kunstlæder";
		price.innerText = "10.458 DKK";
	}
